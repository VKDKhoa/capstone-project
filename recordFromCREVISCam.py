...
def demo():
    ...
    set_double_node(b"ExposureTime", 250)
    set_int_node(b"GainRaw", 200000)
    ...
    recording = False
    out = None
    save_folder = "/home/pi/capstone-project/CREVIS_IMG/Video"
    ...
    while isGrab:
        ...
        if key == ord('c') or key == ord('C'):
            if not recording:
                filename = time.strftime("record7") + ".avi"
